...
class conv_bn_relu3d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 padding=0, dilation=1, groups=1, bias=True):
        super(conv_bn_relu3d, self).__init__()
...
class MFE(nn.Module):
    ...
    def __init__(self, input_channels, input_channels2, n_classes, patch_size):
        ...
        self.conv1_a = conv_bn_relu3d(input_channels, 8, kernel_size=3, padding=1, bias=True)
        ...
        self.conv2_a = conv_bn_relu3d(8, 16, kernel_size=3, padding=1, bias=True)
        ...
        self.conv3_a = conv_bn_relu(1600, self.planes_a[2], kernel_size=3, padding=1, bias=True)
    ...
    def forward(self, x1, x2):
        ...
        x1 = x1.view(x1.size(0), x1.size(1)*x1.size(2), x1.size(3), x1.size(4))
